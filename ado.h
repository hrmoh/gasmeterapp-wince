...
#import "C:\Windows CE Tools\adoce31.dll" rename_namespace("ADOCG") rename("EOF", "EndOfFile")
using namespace ADOCG;

//typedef _Connection*	_ConnectionPtr;
//typedef _Recordset*		_RecordsetPtr;
