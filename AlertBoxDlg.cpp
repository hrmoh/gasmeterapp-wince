// AlertBoxDlg.cpp : implementation file
//
...
CAlertBoxDlg::CAlertBoxDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CAlertBoxDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CAlertBoxDlg)
	m_sMyAlert = _T("");
	//}}AFX_DATA_INIT
}


void CAlertBoxDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CAlertBoxDlg)
	DDX_Text(pDX, IDC_SADRTITLE, m_sMyAlert);
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CAlertBoxDlg, CDialog)
	//{{AFX_MSG_MAP(CAlertBoxDlg)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CAlertBoxDlg message handlers

BOOL CAlertBoxDlg::OnInitDialog() 
{
...
void CAlertBoxDlg::PersianizeMe()
{
	CString sWindowText;
...
void CAlertBoxDlg::FullScreenMe()
{
	CRect rect;
