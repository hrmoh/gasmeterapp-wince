// NotFoundDlg.cpp : implementation file
//
...
CNotFoundDlg::CNotFoundDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CNotFoundDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CNotFoundDlg)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void CNotFoundDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CNotFoundDlg)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CNotFoundDlg, CDialog)
	//{{AFX_MSG_MAP(CNotFoundDlg)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CNotFoundDlg message handlers

BOOL CNotFoundDlg::OnInitDialog() 
{
...
void CNotFoundDlg::PersianizeMe()
{
	CString sWindowText;
...
void CNotFoundDlg::FullScreenMe()
{
	CRect rect;
