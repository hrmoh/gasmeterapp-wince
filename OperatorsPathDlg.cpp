// OperatorsPathDlg.cpp : implementation file
//
...
COperatorsPathDlg::COperatorsPathDlg(CWnd* pParent /*=NULL*/)
	: CDialog(COperatorsPathDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(COperatorsPathDlg)
	m_sOpCode = _T("");
	m_sPass = _T("");
	//}}AFX_DATA_INIT
}
...
void COperatorsPathDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(COperatorsPathDlg)
	DDX_Text(pDX, IDC_EOPCODE, m_sOpCode);
	DDX_Text(pDX, IDC_EPASS, m_sPass);
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(COperatorsPathDlg, CDialog)
	//{{AFX_MSG_MAP(COperatorsPathDlg)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// COperatorsPathDlg message handlers

BOOL COperatorsPathDlg::OnInitDialog() 
{
...
void COperatorsPathDlg::PersianizeMe()
{
	CString sWindowText;
	...
	GetDlgItem(IDC_SOPCODETITLE)->GetWindowText(sWindowText);	
	GetDlgItem(IDC_SOPCODETITLE)->SetWindowText(Arabize(sWindowText));	
...
void COperatorsPathDlg::FullScreenMe()
{
	CRect rect;
