// CustomersMoreinfoDlg.cpp : implementation file
//
...
CCustomersMoreinfoDlg::CCustomersMoreinfoDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CCustomersMoreinfoDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CCustomersMoreinfoDlg)
	m_sAddress = _T("");
	//}}AFX_DATA_INIT
}


void CCustomersMoreinfoDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CCustomersMoreinfoDlg)
	DDX_Text(pDX, IDC_SADDRESS, m_sAddress);
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CCustomersMoreinfoDlg, CDialog)
	//{{AFX_MSG_MAP(CCustomersMoreinfoDlg)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CCustomersMoreinfoDlg message handlers

BOOL CCustomersMoreinfoDlg::OnInitDialog() 
{
	CDialog::OnInitDialog();
	
	FullScreenMe();
	CenterWindow();
	GetDlgItem(IDC_SFRAME)->SetWindowText(m_sSubscriptionCode);
	PersianizeMe();
...
void CCustomersMoreinfoDlg::PersianizeMe()
{
	CString sWindowText;
	...
	GetDlgItem(IDC_SADDRESS)->GetWindowText(sWindowText);	
	GetDlgItem(IDC_SADDRESS)->SetWindowText(Arabize(sWindowText));	

}

void CCustomersMoreinfoDlg::FullScreenMe()
{
	CRect rect;
